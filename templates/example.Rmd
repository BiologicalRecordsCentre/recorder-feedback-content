...
ggplot() +
  ggspatial::annotation_map_tile(zoomin = -1) + # loads background map tiles from a tile source
...
This email was generated at `r Sys.time()`.

Put any disclaimers / information text as a footer in here.

No longer want to receive these emails? Click [here](https://www.irecord.org.uk)
