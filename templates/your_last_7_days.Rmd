...
last_week <- current_date - c(0,1,2,3,4,5,6,7)
...
In the past 7 days you recorded on `r n_days_week` days submitting a total of `r n_records_week` records. You recorded `r n_species_week` different species. 

```{r}

if (n_records_week>0){
  text1 <- paste0("Your top five species sightings included: ",paste0(head(species_names_week,5),collapse = ", "),". Wow!")
} else {
