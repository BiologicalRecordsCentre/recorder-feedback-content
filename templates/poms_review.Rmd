...
So far in 2025 you have contributed **`r params$user_computed_objects$mean_n_fit_counts`** FIT Counts. 

```{r}
first_point <- data.frame(cumulative = 0,day = lubridate::floor_date(as.POSIXct("2025-03-01"), "day"))
